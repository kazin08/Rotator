...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { sys_clk }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100] clk
create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { sys_clk }]; #CLK100MHZ
...
set_property -dict { PACKAGE_PIN B8    IOSTANDARD LVCMOS33 } [get_ports { rst }]; #IO_L12P_T1_MRCC_16 Sch=btn[3]
...
## USB-UART Interface
set_property -dict { PACKAGE_PIN D10   IOSTANDARD LVCMOS33 } [get_ports { rxd_pin }]; #IO_L19N_T3_VREF_16 Sch=uart_rxd_out
